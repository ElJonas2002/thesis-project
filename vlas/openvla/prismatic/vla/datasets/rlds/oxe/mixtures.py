...
OXE_NAMED_MIXTURES: Dict[str, List[Tuple[str, float]]] = {
    ...
    # === Franka-only Fine-tuning Mixture (thesis project) ===
    #   Only the Franka Emika Panda datasets downloaded locally under `datasets/`.
    #   Weights reuse the per-dataset weights from `rtx_franka` / `oxe_magic_soup`.
    "franka_finetune": [
        ("taco_play", 2.0),
        ("viola", 2.0),
